    ...
    <body className="main">
      ...
      <div className="title-container">
        ...
        <div className="title">
          ...
          <h1 class="animate__animated animate__fadeInDown" style={{fontSize:"21px"}}>
            ...
            <span style={{color:'coral',fontSize:"35px"}}> O</span>ntologies, Language 
            <span style={{color:'coral',fontSize:"35px"}}> P</span>rocessing and 
            <span style={{color:'coral',fontSize:"35px"}}> E</span>-humanities
          </h1>
        </div>
      </div>
      ...
      <div className="about-container">
        ...
        <div class="about-description" style={{width:"80vw", marginBottom:"10vh"}}>
          ...
          <Row md="2" xs="1" >
            <Col>
              <Description imgSrc={gears} Name="語言資源建置" 
              Content="建構詞彙網、語料庫等各式語言資源供大眾使用。" />
            </Col>

            <Col>
              <Description imgSrc={brain} Name="語言認知及計算" 
          ...
          <Row md="2" xs="1" >
            ...
            <Col>
              <Description imgSrc={nlp} Name="自然語言處理" 
              Content="對話系統、資訊檢索、知識圖譜建立及社群媒體分析、語言及性別、社會等等量化分析。" />
            </Col>

            <Col>
              <Description imgSrc={text_analytics} Name="資料科學與文本分析" Content="利用機器學習、深度學習進行文本分析和語言的多模態觀察。" />
            </Col>
          </Row>
      ...
      <div className="language-resource-container">
        ...
        <div style={{width:"85vw", minHeight:"70vh", padding:"10px", borderRadius:"10px"}}>
          <Row md="3" xs="1">
            <Col>
              <ResourceCard title="Chinese Wordnet (CWN)" imgSrc= {cwn} href="https://lopentu.github.io/CwnWeb/#home"
              text="以中文為核心的巨量開放詞庫，放棄原子論式的詞彙觀點，讓我們把它開發成為詞彙相關研究的基礎建設。"/>
            </Col>
            <Col>
              <ResourceCard title="PTT 語料庫" imgSrc={ptt_corp} href="http://140.112.147.132:9898/"
              text="作為一個台灣特有的 BBS 系統，PTT 記錄了珍貴而有趣的社會語言文化現象。提供了語言接觸與演化和「精簡語言學」重要的經驗訊息。"/>
            </Col>
            <Col>
              <ResourceCard title="Chinese variation" imgSrc={chi_var} href="https://lopen.linguistics.ntu.edu.tw/chivar/"
          ...
          <Row md="3" xs="1">
            <Col>
              <ResourceCard title="Lopatator" imgSrc={lopotator} href="https://lopen.linguistics.ntu.edu.tw/lope.anno/"
              text="Lopen 語料標記系統"/>
            </Col>
            <Col >
              <ResourceCard title="Chinese Word Map (CWM)" imgSrc={cwm} href="http://lope.linguistics.ntu.edu.tw/cwm/"
