        ...
        <div class="content" style={{display: "block"}}>
                <ul class="icon-list">
                    ...
                    <li class="publi"><strong>Shu-Kai Hsieh</strong>, <strong>Yu-Yun Chang</strong> and <strong>Meng-Xian Shih</strong>. Chinese Sentiments on the Clouds: A Preliminary Experiment on Corpus Processing and Exploration on Cloud Service. The 26th Pacific Asia Conference on Language Information and Computing (PACLIC 26), Bali, Indonesia.
                        <a href="https://lope.linguistics.ntu.edu.tw/att/paclic26_submission_96.pdf" target="_blank" rel="noreferrer"> <img src={pdf_icon} alt="pdf" width="25px"/></a></li>
                    ...
                    <li class="publi">Sheng-Fu Wang, Jing-Chen Yang, <strong>Yu-Yun Chang</strong>, <strong>Yu-Wen Liu</strong>, and <strong>Shu-Kai Hsieh</strong>. Frequency, Collocation, and Statistical Modeling of Lexical Items: A Case Study of Temporal Expressions in Two Conversational Corpora. International Journal of Computational Linguistics and Chinese Language Processing 17(2): 37-54.
                      <a href="https://lope.linguistics.ntu.edu.tw/att/2012_IJCLCLP_v17n2a3.pdf" target="_blank" rel="noreferrer"> <img src={pdf_icon} alt="pdf" width="25px"/></a></li>
                    <li class="publi">
